defmodule BestCoffeeTruckWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BestCoffeeTruckWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BestCoffeeTruckWeb.Gettext, "errors", msg, opts)
    end
  end
